...
public class Main {
    ...
    private static ArrayList<Example> readDataSet(String file){
    ...
    public static void main(String[] args){
        ArrayList<Example> examples = readDataSet("C:\\Users\\USER\\Documents\\NetBeansProjects\\LogisticRegression\\src\\BreastCancer");
        ...
        System.out.println("\n The probabilities that the test examples are classified in category M are :\n");
         try{
            File file1 = new File("C:\\Users\\USER\\Documents\\NetBeansProjects\\LogisticRegression\\src\\testData");
            Scanner scanner = new Scanner(file1);
